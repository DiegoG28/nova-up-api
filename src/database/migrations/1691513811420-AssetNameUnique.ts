...
export class AssetNameUnique1691513811420 implements MigrationInterface {
    name = 'AssetNameUnique1691513811420'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`recurso\` DROP FOREIGN KEY \`FK_0271858854b96137befdd4e1963\``);
        await queryRunner.query(`ALTER TABLE \`recurso\` DROP COLUMN \`nombre_recurso\``);
        await queryRunner.query(`ALTER TABLE \`recurso\` ADD \`nombre_recurso\` varchar(500) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`recurso\` ADD UNIQUE INDEX \`IDX_84e99f10d0c781a4ac8e37b54c\` (\`nombre_recurso\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`recurso\` DROP INDEX \`IDX_84e99f10d0c781a4ac8e37b54c\``);
        await queryRunner.query(`ALTER TABLE \`recurso\` DROP COLUMN \`nombre_recurso\``);
        await queryRunner.query(`ALTER TABLE \`recurso\` ADD \`nombre_recurso\` varchar(120) COLLATE "utf8mb4_general_ci" NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`recurso\` ADD CONSTRAINT \`FK_0271858854b96137befdd4e1963\` FOREIGN KEY (\`id_publicacion\`) REFERENCES \`publicacion\`(\`id_publicacion\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
