...
export class PostTypeEnum1688402434827 implements MigrationInterface {
    name = 'PostTypeEnum1688402434827'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`tipo_publicacion\` \`tipo_publicacion\` enum ('Evento', 'Convocatoria externa', 'Convocatoria interna', 'Proyecto', 'Investigación') NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`id_carrera\` \`id_carrera\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`usuario\` ADD CONSTRAINT \`FK_62b68676176f06eeabb8a361a99\` FOREIGN KEY (\`id_departamento\`) REFERENCES \`departamento\`(\`id_departamento\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`usuario\` ADD CONSTRAINT \`FK_3628e9894c4b014d61a01cb21dd\` FOREIGN KEY (\`id_rol\`) REFERENCES \`rol\`(\`id_rol\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`id_carrera\` \`id_carrera\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`id_categoria\` \`id_categoria\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`comentario\` \`comentario\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`tipo_publicacion\` \`tipo_publicacion\` enum ('Evento', 'Convocatoria externa', 'Convocatoria interna', 'Proyecto') NOT NULL`);
