...
export class IsCanceledDefaultValue1690561676824 implements MigrationInterface {
    name = 'IsCanceledDefaultValue1690561676824'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`cancelado\` \`cancelado\` tinyint NOT NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`cancelado\` \`cancelado\` tinyint NOT NULL`);
