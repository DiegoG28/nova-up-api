...
export class HashAssetField1691517108597 implements MigrationInterface {
    name = 'HashAssetField1691517108597'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`recurso\` ADD \`hash\` varchar(64) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`recurso\` DROP COLUMN \`hash\``);
    }
