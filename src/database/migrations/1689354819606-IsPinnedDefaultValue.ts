...
export class IsPinnedDefaultValue1689354819606 implements MigrationInterface {
    name = 'IsPinnedDefaultValue1689354819606'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`fijado\` \`fijado\` tinyint NOT NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`fijado\` \`fijado\` tinyint NOT NULL`);
