...
export class IsCanceledDeleted1693329953394 implements MigrationInterface {
    name = 'IsCanceledDeleted1693329953394'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`publicacion\` DROP COLUMN \`cancelado\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`recurso\` ADD CONSTRAINT \`FK_0271858854b96137befdd4e1963\` FOREIGN KEY (\`id_publicacion\`) REFERENCES \`publicacion\`(\`id_publicacion\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`publicacion\` ADD \`cancelado\` tinyint NOT NULL DEFAULT '0'`);
    }
