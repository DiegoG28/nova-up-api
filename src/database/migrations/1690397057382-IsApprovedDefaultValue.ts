...
export class IsApprovedDefaultValue1690397057382 implements MigrationInterface {
    name = 'IsApprovedDefaultValue1690397057382'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`aprobado\` \`aprobado\` tinyint NOT NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`publicacion\` CHANGE \`aprobado\` \`aprobado\` tinyint NOT NULL`);
